...
unsigned long interval[3] = {500,1000,0};
...
void loop() {
  ...
  // }
    // if(loraWireless.available()>1){
      ...
      ResponseContainer rc = loraWireless.receiveMessage();// dia langsung set data rc status ke 1
      //void receive
      if(rc.status.code!=1){
  ...
  //   // loraSerial.println("Halo 1");
  //   // loraSerial.write("Halo 2");
